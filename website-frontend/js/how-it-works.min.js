...
jQuery(function(e){"use strict";const s=e(".line"),l=e(".input"),o=e("#menu-toggle");o.click(function(){e(this).toggleClass("open"),e(".logo-block").toggleClass("open-menu"),o.hasClass("open")?(e("html").css("overflow","hidden"),e(".mob-hidden").addClass("hidden")):(e("html").css("overflow","scroll"),e(".mob-hidden").removeClass("hidden"))}),e(window).on("scroll",function(){const l=e(".logo-hide, .plans-page, .main-bg, .all-pages, .header-bg");e(this).scrollTop()>0?(l.addClass("scroll-block"),s.hide()):(l.removeClass("scroll-block"),s.show())}),l.hover(function(){e(this).parent().addClass("focus_input")},function(){e(this).parent().removeClass("focus_input")}),e(".question-block, .close-answer").on("click",function(){e(this).parent().find(".show-me").toggleClass("hidden"),e(this).parent().find(".open").toggleClass("hidden"),e(this).parent().find(".close").toggleClass("hidden")});let n=e("#switch"),t=e("#switch_second");function i(s){e(".plans-check").toggleClass("yearly-price"),e(".table-plans").toggleClass("table-yearly-price"),s.prop("checked",!s.prop("checked"))}n.on("change",function(){i(t)}),t.on("change",function(){i(n)}),e(".team-show-more, .team-less-more, .info, .avatar").on("click",function(s){s.preventDefault();let l=e(this).parents(".blocks"),o=l.find(".hidden-block");l.find(".team-less-more").toggleClass("hidden"),l.find(".team-show-more").toggleClass("hidden"),o.toggleClass("hidden"),l.find(".info").toggleClass("dots"),o.hasClass("hidden")&&e("html, body").animate({scrollTop:l.offset().top-80},200)}),e(".hidden-link").on("click",function(s){s.preventDefault();let l=e(".table-plans");l.children(".cols").removeClass("active"),e("html, body").animate({scrollTop:l.offset().top-165},1400);let o=e(this).data("plan");e(`.${o}`).addClass("active")}),e(".plans-blocks").hasClass("slick-center")&&e(".slick-center").find(".hidden-link").removeClass("hidden")});!function(e,t,a,n,g){e[n]=e[n]||[],e[n].push({"gtm.start":(new Date).getTime(),event:"gtm.js"});var m=t.getElementsByTagName(a)[0],r=t.createElement(a);r.async=!0,r.src="https://www.googletagmanager.com/gtm.js?id=GTM-N8TBP3C",m.parentNode.insertBefore(r,m)}(window,document,"script","dataLayer");jQuery(function(t){"use strict";const e=t(".input"),i=t("#submit-form-subscribe");t("#contact-us").MailChimpForm({url:"https://mitocgroup.us11.list-manage.com/subscribe/post?u=13a7a5fca813b378c24ec9fe3&id=d87b64561f",fields:"0:EMAIL,1:FNAME,2:COMPANY,3:WEBSITE,4:MESSAGE",inputSelector:".input",submitSelector:"#submit-form",onFail:function(e){let i=t("#mc-general-error");i.html(`<div class="error-mc">${e}</div>`),setTimeout(()=>{i.html("")},5e3)},onOk:function(t){window.location=`/contact-successful/?mc-message=${t}`}}),t("#subscribe-form").MailChimpForm({url:"https://mitocgroup.us11.list-manage.com/subscribe/post?u=13a7a5fca813b378c24ec9fe3&amp;id=e75049837b",fields:"0:EMAIL",inputSelector:".input",submitSelector:"#submit-form-subscribe",onFail:function(e){let i=t("#mc-general");i.html(`<div class="error-mc">${e}</div>`),setTimeout(()=>{i.html("")},5e3)},onOk:function(t){window.location=`/contact-successful/?mc-message=${t}`}}),t("#subscribe-form").on("submit",function(e){e.preventDefault(),t(i).trigger("click")}),t("#subscribe-form-blog").MailChimpForm({url:"https://mitocgroup.us11.list-manage.com/subscribe/post?u=13a7a5fca813b378c24ec9fe3&amp;id=e75049837b",fields:"0:EMAIL",inputSelector:".input",submitSelector:"#submit-blog-subscride",onFail:function(e){let i=t("#mc-general");i.html(`<div class="error-mc">${e}</div>`),setTimeout(()=>{i.html("")},5e3)},onOk:function(t){window.location=`/contact-successful/?mc-message=${t}`}}),e.on("mc:input:error",function(){t(this).addClass("error")}),e.on("mc:input:ok",function(){t(this).removeClass("error")})});jQuery(function(i){"use strict";const s=i(".plans-blocks"),e=i(".carousel-plans"),n=i(".carousel-schema");e.slick({slidesToShow:1,slidesToScroll:1,infinite:!1,dots:!1,centerMode:!0,arrows:!1,responsive:[{breakpoint:2e3,settings:"unslick"},{breakpoint:680,settings:{infinite:!0,dots:!0,centerMode:!0,focusOnSelect:!0,slidesToShow:1,initialSlide:0,arrows:!1}}]}),n.slick({slidesToShow:3,slidesToScroll:1,infinite:!1,dots:!1,arrows:!1,initialSlide:0,responsive:[{breakpoint:2e3,settings:"unslick"},{breakpoint:992,settings:{infinite:!1,dots:!0,focusOnSelect:!0,slidesToShow:2,initialSlide:1,arrows:!0}},{breakpoint:680,settings:{infinite:!1,dots:!0,slidesToShow:1,initialSlide:0,arrows:!0}}]}),i(window).on("resize",function(){i(window).width()<680&&s.not(".slick-center").removeClass("active")}),s.on("click",function(){i(".hidden-link").not(".slick-center").addClass("hidden"),s.not(".slick-center").removeClass("active"),i(this).find(".hidden-link").removeClass("hidden"),i(this).addClass("active"),s.each(function(){i(this).removeClass("active")}),i(this).addClass("active")})});